            ...
            <div className="offset-sm-1 col-sm-6 p-2">
              <div data-aos="slide-down" className="row m-auto p-1">
                <div className="col-sm-12 vol text-left pb-4 mb-2">
                  <h1 data-aos="" className="font">
                    Volunteer
                  </h1>
                </div>
                <div data-aos="fade-in" className="col-sm-12 text-left mt-1">
                  <h6 className="mt-2 font3">
                    <b>Personal Details</b>
                  </h6>

                  <div className="form-group">
                    <label className="m-0 mt-2" for="name">
                      Name
                    </label>
                    <input
                      type="text"
                  ...
                  <div class="row m-auto">
                    <div class="col-sm-6 p-1">
                      <label className="m-0 mt-2" for="phone">
                        Phone
                      </label>
                      <input
                        type="string"
                    ...
                    <div class="col-sm-6 p-1">
                      <label className="m-0 mt-2" for="email">
                        Email
                      </label>
                      <input
                        type="email"
                    ...
                    <div class="col-sm-6 p-1">
                      <label className="m-0 mt-2" for="nation">
                        Emergency Contact
                      </label>
                      <input
                        type="number"
                  ...
                  <div class="row m-auto">
                    <div className="col-sm-6 p-1">
                      <label className="m-0 mt-2" for="gender">
                        Current Address
                      </label>
                      <select
                    ...
                    <div className="col-sm-6 hours p-1 mb-4">
                      <label className="m-0 mt-2" for="age">
                        Working Hours
                      </label>
                      <input
                        type="number"
            ...
            <div className="col-sm-5 p-2">
              <div className="row m-auto m-3 text-left">
                <div className="col-sm-12 vol">
                  <h6 data-aos="fade-up" className="font3">
                    <b>Qualification</b>
                  </h6>
                </div>
                <div data-aos="fade-right" className="col-sm-12 mt-3">
                  <div className="form-group">
                    <label className="m-0 mt-2 mb-1" for="address">
                      <h6 className="font3">Educational Qualification</h6>{" "}
                      (Mention upto the latest degree)
                    </label>
                    <div className="form-group">
                      <label className="m-0 mt-2 col-sm-6" for="building">
                        <h5 className="font3">Degree:</h5>
                      </label>
                      <input
                        type="text"
                        className="m-0 mt-2 col-sm-6 btn"
                        id="building"
                        name="degree"
                      />
                    </div>
                    ...
                    <div className="form-group">
                      <label className="m-0 mt-2 col-sm-6" for="building">
                        <h5 className="font3">University:</h5>
                      </label>
                      <input
                        type="text"
                        className="m-0 mt-2 col-sm-6 btn"
                    ...
                    <div className="form-group">
                      <label className="m-0 mt-2 col-sm-6" for="building">
                        <h5 className="font3">Location:</h5>
                      </label>
                      <input
                        type="text"
                        className="m-0 mt-2 col-sm-6 btn"
                ...
                <div data-aos="fade-right" className="col-sm-12 mt-3">
                  <div className="form-group">
                    <label className="m-0 mt-2 mb-1" for="address">
                      <h6 className="font3">Professional Qualification </h6>{" "}
                      (Mention upto the latest degree)
                    </label>
                    <div className="form-group">
                      <label className="m-0 mt-2 col-sm-6" for="building">
                        <h5 className="font3">Organisation:</h5>
                      </label>
                      <input
                        type="text"
                        className="m-0 mt-2 col-sm-6 btn"
                    ...
                    <div className="form-group">
                      <label className="m-0 mt-2 col-sm-6" for="building">
                        <h5 className="font3">Position:</h5>
                      </label>
                      <input
                        type="text"
                        className="m-0 mt-2 col-sm-6 btn"
                    ...
                    <div className="form-group">
                      <label className="m-0 mt-2 col-sm-6" for="building">
                        <h5 className="font3">Duration:</h5>
                      </label>
                      <input
                        type="text"
                        className="m-0 mt-2 col-sm-6 btn"
                    ...
                    <div className="form-group">
                      <label className="m-0 mt-2 col-sm-6" for="building">
                        <h5 className="font3">Roles and Responsibilities:</h5>
                      </label>
                      <input
                        type="text"
                        className="m-0 mt-0 col-sm-6 btn"
                        id="building"
                        name="roles"
                      />
                    </div>
                    ...
                    <div className="form-group">
                      <label className="m-0 mt-2 col-sm-6" for="building">
                        <h5 className="font3">Name of Organisation:</h5>
                      </label>
                      <input
                        type="text"
                        className="m-0 mt-2 col-sm-6 btn"
                    ...
                    <div className="form-group">
                      <label className="m-0 mt-2 col-sm-6" for="building">
                        <h5 className="font3">Position or Department:</h5>
                      </label>
                      <input
                        type="text"
                        className="m-0 mt-2 col-sm-6 btn"
                    ...
                    <div className="form-group">
                      <label className="m-0 mt-2 col-sm-6" for="building">
                        <h5 className="font3">Roles & Responsibilities:</h5>
                      </label>
                      <input
                        type="text"
                        className="m-0 mt-2 col-sm-6 btn"
            ...
            <div className="offset-sm-1 mt-2 col-sm-6">
              <div className="row m-auto text-left m-4">
                ...
                <div data-aos="fade-left" className="col-sm-12 mt-5">
                  <div className="form-group">
                    <label className="m-0 mb-1 mt-2" for="about">
                      Any specific Interest in any art form.
                      <i className="text-danger">*</i> Others,specify
                    </label>
                    <select
                      className="form-control btn btn-secondary"
                      name="interest"
                    >
                      <option value="dance" selected>
                        Dance
                      </option>
                  ...
                  <div className="form-group">
                    <label className="m-0 mb-1 font3 mt-2" for="about">
                      <p className="m-2">
                        In this section, kindly express your personal views for
                        or against the following statements in not less than 150
                        words. You can pick any 2 statements.
                      </p>
                      <h6 className="m-2">
                        <b>1.</b> Delhi Government’s initiative for creating
                        learning opportunities for EWS children is the only way
                        to bring best education practices to disadvantaged
                        children.
                      </h6>

                      <h6 className="m-2">
                        <b>2.</b> The only growth most important for a child is
                        their educational growth. Extra-curricular activities
                        are fun but wanting to build a career on it is a foolish
                        approach to success.
                      </h6>

                      <h6 className="m-2">
                        <b>3.</b> When concerning oneself with empowering
                        underprivileged children, one must always acknowledge
                        the gender implications of your actions. For eg., to
                        ensure upliftment of a society in a true sense,
                        initiatives should focus on inclusion and equal
                        opportunities for male and female children.
                      </h6>
                    </label>
                    <textarea
                      type="text"
                ...
                <div
                  data-aos="fade-up"
                  className="col-sm-12 text-center mt-2 vol"
                >
                  <h5 className="font3">Verification</h5>
                </div>
                <div className="col-sm-12 mt-3">
                  <div className="form-group">
                    <label className="m-0 mt-2" for="verify">
                      Enter any 2 digits
